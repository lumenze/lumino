    ...
    <div style={{ display: 'flex', minHeight: '100dvh', position: 'relative' }}>
      ...
      >
        ...
        <div style={{ flex: 1, padding: '12px 0' }}>
          <NavItem href='/' label='Dashboard' icon='📊' onClick={() => setMenuOpen(false)} />
          <NavItem href='#' label='Accounts' icon='💳' />
          <NavItem href='#' label='Payments' icon='↗️' />
          <NavItem href='#' label='Statements' icon='📄' />
          <NavItem href='/settings' label='Card Settings' icon='⚙️' active data-nav='card-settings' onClick={() => setMenuOpen(false)} />
      ...
      <main style={{ flex: 1, overflow: 'auto', width: '100%' }}>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <div>
              <h1 style={{ fontSize: isMobile ? 16 : 18, fontWeight: 700 }}>Card Settings</h1>
